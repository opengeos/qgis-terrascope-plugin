#!/bin/bash
# Installation script for Terrascope QGIS Plugin
#
# Usage:
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  --name, -n NAME   Plugin folder name (default: terrascope)"
...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    echo "Please manually copy the terrascope folder to your QGIS plugins directory."
    exit 1
fi
