"""
UV Package Installer Manager for Terrascope Plugin.
...
def download_uv(
    ...
    Args:
        progress_callback: Function called with a status message string.
    ...
    if progress_callback:
        progress_callback(f"Downloading uv {UV_VERSION}...")
    ...
    try:
        ...
        if progress_callback:
            ...
            progress_callback(f"Downloaded {total_mb:.1f} MB, extracting...")
        ...
        if progress_callback:
            progress_callback("Verifying uv installation...")
