"""
Update Checker Dialog for Terrascope Plugin
...
GITHUB_REPO = "opengeos/qgis-terrascope-plugin"
GITHUB_BRANCH = "main"
PLUGIN_PATH = "terrascope"
METADATA_URL = (
...
class DownloadWorker(QThread):
    ...
    def run(self):
        ...
        temp_dir = None
        try:
            temp_dir = tempfile.mkdtemp(prefix="terrascope_update_")
            ...
            for root, dirs, files in os.walk(extract_dir):
                if "metadata.txt" in files and "terrascope_plugin.py" in files:
            ...
            try:
                ...
                def is_valid_plugin_dir(path):
                    ...
                    ) and os.path.exists(os.path.join(path, "terrascope_plugin.py"))
...
class UpdateCheckerDialog(QDialog):
    ...
    def __init__(self, plugin_dir, parent=None):
        ...
        self.setWindowTitle("Terrascope Plugin Update")
    ...
    def _setup_ui(self):
        ...
        # Header
        header_label = QLabel("Terrascope Plugin Update Checker")
        header_font = QFont()
    ...
    def _on_download_finished(self, install_path):
        ...
        QMessageBox.information(
            self,
            "Update Complete",
            f"Terrascope plugin has been updated to version "
